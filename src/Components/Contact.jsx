  ...
  return (
    <div id="contact" className="py-12">
      <div className="container mx-auto px-4">
        <div className="relative bg-cover bg-center h-64 mb-8 max-w-3xl mx-auto" style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1507525428034-b723cf961d3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80")' }}>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center space-x-6">
              <a
                ...
                className="text-teal-800 hover:text-teal-600 transition duration-300 hover:scale-110 flex items-center"
              >
