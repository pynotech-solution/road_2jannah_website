  ...
  return (
    <div id="contact" className="py-12">
      <div className="container mx-auto sm:px-4 px-0">
       <div className="relative bg-cover bg-center h-64 mb-8 mx-auto" style={{ backgroundImage: `url('https://res.cloudinary.com/dzqdfaghg/image/upload/v1750039598/4_epuoto.jpg')` }}>
