  ...
  return (
    <div id="contact" className="py-12">
      <div className="container mx-auto sm:px-4 px-0">
        <div className="relative bg-cover bg-center h-64 mb-8 mx-auto" style={{ backgroundImage: 'https://scontent.facc1-1.fna.fbcdn.net/v/t39.30808-6/472206263_8807425239293997_4094478365450783416_n.jpg?_nc_cat=110&ccb=1-7&_nc_sid=2285d6&_nc_eui2=AeFgYvaMkYwsdtWa3NtNCa2UEYhCQPwVae0RiEJA_BVp7W2KnehFDQ-xDrdjeeJYwmeTeIUkk1kh6XXtX6kQj77A&_nc_ohc=jWxRMDxY_HUQ7kNvwGH0kN0&_nc_oc=Adnj3WEME20Qa9U6c5Kj9i8qK873ooNR6uxpp-_clTSp94dQkxnlFUAPVKM7sFRdhwM&_nc_zt=23&_nc_ht=scontent.facc1-1.fna&_nc_gid=OvAQ33Q7QzAvVSA8sO_8Eg&oh=00_AfOXy2G1Sdr1T2KwOESq8GN3nb_dqVRUb5dRhWQdruzgPQ&oe=684FCC39' }}>
